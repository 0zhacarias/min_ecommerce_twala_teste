...
@if ($isOpenDialogEncomenda)
        <div class="fixed inset-0 bg-black bg-opacity-50 z-50 transition-opacity" wire:click="fecharDialogEncomenda"></div>
    @endif
        ...
        <div class="flex min-h-full items-center justify-center p-4">
            <div class="relative bg-white rounded-lg shadow-xl w-full max-w-md transform transition-all" wire:click.stop>
                ...
                <div class="flex items-center justify-between p-6 border-b border-gray-200">
                    ...
                    <button wire:click="fecharDialogEncomenda" class="text-gray-400 hover:text-gray-600 transition-colors">
